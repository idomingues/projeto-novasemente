...
export const adminSidebarRoutePermissions: Record<string, string[]> = {
    ...
    'ministry-lead.volunteers.central': ['volunteers.view', 'volunteers.manage', 'volunteers.ministry_operate'],
    'ministry-lead.volunteers.pedidos': ['volunteers.view', 'volunteers.manage', 'volunteers.ministry_operate'],
    'ministry-lead.volunteers.index': ['volunteers.view', 'volunteers.manage', 'volunteers.ministry_operate'],
    // “Meus voluntários” aparece para quem tem propriedade Líder (`is_ministry_leader`).
    ...
    'ministry-lead.volunteers.pipeline.notes.destroy': ['volunteers.ministry_operate', 'volunteers.manage'],
    ...
    'conviva.index': ['conviva.view', 'conviva.manage'],
    ...
    'revista-adventista-acervo.index': ['news.view', 'news.manage'],
    'revista-adventista-acervo.edition.active': ['news.manage'],
    'revista-adventista-acervo.sync-archive': ['news.manage'],
    'mission.index': ['mission.view', 'mission.manage'],
    'mission.users.index': ['mission.view', 'mission.manage'],
    'mission.users.update': ['mission.manage'],
    ...
    'mission.content.messages.store': ['mission.manage'],
    'mission.content.messages.visibility': ['mission.manage'],
    'mission.content.messages.approve': ['mission.manage'],
    'mission.content.messages.reject': ['mission.manage'],
    ...
    'conversations.index': ['conversations.view', 'conversations.manage', 'conversations.admin'],
