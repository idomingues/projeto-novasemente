...
export default function MobileRevistaAdventistaShow({ edition }: Props) {
    return (
        <MobileLayout>
            ...
            <div className="-mx-4 min-w-0 overflow-x-hidden sm:mx-0">
                <div className="mb-3 px-4 sm:px-0">
                    <Link
                        href={route('mobile.revista-adventista', { ano: edition.year })}
                ...
                <PdfTextReaderScreen
                    ...
                    downloadUrl={route('mobile.revista-adventista.pdf-download', edition.id)}
