        ...
        <MobileLayout>
            ...
            <div className="mx-auto max-w-3xl space-y-6">
                            ...
                            <div className="flex flex-col gap-4 sm:flex-row sm:items-center">
                                ...
                                <div className="min-w-0 flex-1 text-center sm:text-left">
                                    ...
                                    <p className="mt-1 text-sm leading-relaxed text-zinc-600 dark:text-zinc-400">
                                        Se você já prefere usar o 7me, abra o link oficial abaixo para concluir sua contribuição.
                                    </p>
                                </div>
                            </div>
                        </div>
                ...
                <div className="rounded-2xl border border-brand-200/90 bg-gradient-to-br from-brand-50 to-white p-4 dark:border-brand-900/55 dark:from-brand-950/45 dark:to-zinc-900">
                    ...
                    <p className="mb-3 text-sm text-zinc-600 dark:text-zinc-400">
                        Gere o código PIX Copia e Cola ou use a chave abaixo. Depois envie o comprovante pelo botão
                        &quot;Contribuir agora&quot;.
                    </p>
                ...
                {recentDonations.length > 0 && (
                    <div className="rounded-2xl border border-zinc-200 bg-white p-4 dark:border-zinc-800 dark:bg-zinc-900">
                        <h2 className="mb-3 font-semibold text-zinc-900 dark:text-white">Contribuições recentes</h2>
            ...
            <Modal show={donateOpen} onClose={() => setDonateOpen(false)} maxWidth="md">
                <form onSubmit={submitDonation} className="space-y-4 p-6">
                    <h3 className="text-lg font-semibold text-zinc-900 dark:text-white">Confirmar contribuição</h3>
