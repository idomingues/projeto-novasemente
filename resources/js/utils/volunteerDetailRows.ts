    ...
    return [
        ...
        },
        {
            ...
            rows: [
                ...
                { label: 'Detalhes da experiência anterior', value: text(v.previous_ministry_details) },
                { label: 'Como quer servir / envolvimento', value: text(v.ministry_involvement) },
                { label: 'Outro ministério ou interesse', value: text(v.other_ministry_interest) },
                ...
                { label: 'Deseja orientação pastoral?', value: yn(v.needs_pastoral_guidance) },
