        ...
        <MobileLayout>
            ...
            <div className="space-y-6 lg:space-y-0">
                <div className="lg:mb-6">
                    ...
                    <p className="mt-3 rounded-xl border border-amber-200/80 bg-amber-50/80 px-3 py-2.5 text-sm leading-relaxed text-amber-950 dark:border-amber-900/40 dark:bg-amber-950/25 dark:text-amber-100">
