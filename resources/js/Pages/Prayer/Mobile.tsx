...
export default function PrayerMobile({ requests, canManage }: Props) {
                ...
                {canManage ? (
                    <Modal show={editOpen} onClose={() => !editForm.processing && setEditOpen(false)}>
                        ...
                        >
                            ...
                            <div className="space-y-4">
                                <div>
                                    <InputLabel htmlFor="edit_prayer_name_m" value="Nome, apelido ou codinome" />
                                    <TextInput
                                        id="edit_prayer_name_m"
                                ...
                                <div>
                                    <InputLabel htmlFor="edit_prayer_request_m" value="Pedido" />
                                    <Textarea
                                        id="edit_prayer_request_m"
