# Sistema de Gestão Igreja – Nova Semente

Este projeto é um painel administrativo para gestão de igreja, construído com:

- Backend: Laravel 12 (PHP 8.2), Inertia.js, Sanctum, spatie/laravel-permission
- Frontend: React 18, TypeScript, Vite, Tailwind CSS 4, Headless UI, Heroicons
...
composer setup        # instala dependências, gera key, migrações e build frontend
php artisan serve     # servidor backend
...
Inclui um teste básico de acesso ao módulo de membros.
