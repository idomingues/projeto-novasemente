        ...
        <MobileLayout>
            ...
            <div className="space-y-6">
                <div>
                    ...
                    <h1 className="text-xl font-bold text-zinc-900 dark:text-white mt-2">Nossos pastores</h1>
                        ...
                        {pastors.map((p) => (
                            ...
                            >
                                <div className="flex flex-col sm:flex-row gap-4 p-4 sm:p-5">
                                    <div className="w-full sm:w-40 h-48 sm:h-40 rounded-xl overflow-hidden bg-zinc-100 dark:bg-zinc-800 shrink-0 flex items-center justify-center mx-auto sm:mx-0">
                                        {p.photoUrl ? (
