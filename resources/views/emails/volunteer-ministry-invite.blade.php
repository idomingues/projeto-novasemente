                    ...
                    <tr>
                        <td style="background:#ffffff;border:1px solid #e4e4e7;border-radius:18px;overflow:hidden;">
                            ...
                            <div style="padding:18px 22px 0;">
                                ...
                                <a href="{{ $registerUrl }}" style="display:inline-block;background:#10b981;color:#ffffff;text-decoration:none;font-family:ui-sans-serif,system-ui,-apple-system,Segoe UI,Roboto,Arial;font-weight:800;font-size:13px;letter-spacing:.06em;text-transform:uppercase;padding:12px 16px;border-radius:999px;">
                            ...
                            <div style="padding:18px 22px 0;">
                                ...
                                <div style="margin-top:10px;">
                                <a href="{{ $inviteUrl }}" style="display:inline-block;background:#10b981;color:#ffffff;text-decoration:none;font-family:ui-sans-serif,system-ui,-apple-system,Segoe UI,Roboto,Arial;font-weight:800;font-size:13px;letter-spacing:.06em;text-transform:uppercase;padding:12px 16px;border-radius:999px;">
                                    Aceitar ou recusar
                                </a>
                                <div style="font-family:ui-sans-serif,system-ui,-apple-system,Segoe UI,Roboto,Arial;font-size:12px;color:#71717a;margin-top:12px;line-height:1.5;">
                                    Se o botão não funcionar, copie e cole este link no seu navegador:<br/>
