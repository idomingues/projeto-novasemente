...
class CampaignDonation extends Model
{
    ...
    {
        return $this->hasMany(CampaignDonationAdjustment::class, 'campaign_donation_id')->orderByDesc('created_at');
    }
    ...
    {
        return $this->dispute_status === self::DISPUTE_PENDING;
    }
    ...
    public function toMobileArray(): array
    {
        return [
            ...
            'adjustment_history' => $this->relationLoaded('adjustments')
                ? $this->adjustments->map(fn (CampaignDonationAdjustment $a) => [
