        ...
        router.post(
            ...
            },
            {
                ...
                onError: (errors) => {
                    ...
                    setError(typeof first === 'string' ? first : 'Não foi possível excluir este voluntário.');
                },
            ...
            {!armed ? (
                <>
                    <p className="mt-1 text-xs text-red-800/90 dark:text-red-300/90">
                        Exclui <strong className="font-semibold">{volunteerName}</strong> da lista de voluntários. Você precisará
