...
export default function Authenticated({
    ...
    return (
        <div
            className="ns-app-shell fixed inset-0 z-0 h-[100dvh] max-h-[100dvh] overflow-y-auto overscroll-y-none bg-gray-100 dark:bg-zinc-900"
                    ...
                    <div className="flex h-16 justify-between">
                                ...
                                <Dropdown>
                                    <Dropdown.Trigger>
                                        <span className="inline-flex rounded-md">
                                            <button
                                                type="button"
                                                className="inline-flex items-center rounded-md border border-transparent bg-white dark:bg-zinc-800 px-3 py-2 text-sm font-medium leading-4 text-gray-500 dark:text-gray-400 transition duration-150 ease-in-out hover:text-gray-700 dark:hover:text-gray-300 focus:outline-none"
                                            >
                                                {user.name}
                        ...
                        <div className="-me-2 flex items-center sm:hidden">
                            <button
                                ...
                                className="inline-flex items-center justify-center rounded-md p-2 text-gray-400 dark:text-gray-500 transition duration-150 ease-in-out hover:bg-gray-100 dark:hover:bg-zinc-900 hover:text-gray-500 dark:hover:text-gray-400 focus:bg-gray-100 dark:focus:bg-zinc-900 focus:text-gray-500 dark:focus:text-gray-400 focus:outline-none"
                            >
                                <svg
                                    className="h-6 w-6"
                                    stroke="currentColor"
