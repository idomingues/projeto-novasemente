                    ...
                    <>
                        ...
                        {myMinistries.length > 0 ? (
                            <div className="mb-3 space-y-0.5">
                                <p className="mb-1.5 px-1 text-[10px] font-bold uppercase tracking-[0.12em] text-teal-800 dark:text-teal-300">
                                    Onde eu sirvo
                                </p>
                                {myMinistries.map((m) => {
                                    ...
                                    return (
                                        <button
                                            ...
                                            className="flex w-full cursor-pointer items-center gap-2.5 rounded-xl px-2.5 py-2 text-left transition hover:bg-teal-50/80 dark:hover:bg-teal-950/40"
                                        >
                                            <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-teal-700/15 text-teal-800 dark:bg-teal-400/20 dark:text-teal-200">
                                            ...
                                            <div className="min-w-0 flex-1">
                                                ...
                                                <p className="mt-0.5 truncate text-[11px] text-teal-800/80 dark:text-teal-200/80">
                        ...
                        {otherMinistries.length > 0 ? (
                            <div className="mb-1 space-y-0.5">
                                {myMinistries.length > 0 ? (
                                    <p className="mb-1.5 px-1 text-[10px] font-bold uppercase tracking-[0.12em] text-zinc-500 dark:text-zinc-400">
                                ...
                                {otherMinistries.map((m) => {
                                    ...
                                    return (
                                        <button
                                            ...
                                            type="button"
                                            onClick={() => pickMinistry(m.id)}
                                            className="flex w-full cursor-pointer items-center gap-2.5 rounded-xl px-2.5 py-2 text-left transition hover:bg-zinc-50 dark:hover:bg-zinc-900/80"
                                        >
