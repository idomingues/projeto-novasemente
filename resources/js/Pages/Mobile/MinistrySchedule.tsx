                            ...
                            {[1, 2, 3, 4, 5].map((n) => {
                                ...
                                return (
                                    <button
                                        ...
                                        type="button"
                                        disabled={!exists}
                                        onClick={() => exists && setActiveSaturday(n)}
                                        title={exists ? `${n}º sábado do mês` : 'Este mês não tem este sábado'}
                                        className={`rounded-2xl py-3 text-sm font-bold transition ${
                                            !exists
                                                ...
                                                : active
                                                  ? 'bg-brand-800 text-white shadow-md ring-1 ring-brand-900/25 dark:bg-brand-600 dark:ring-brand-500/20'
                            ...
                            <section className="rounded-2xl border border-zinc-200 bg-white p-4 shadow-sm dark:border-zinc-700 dark:bg-zinc-900">
                                <div className="flex items-start justify-between gap-3">
                                    <div className="min-w-0">
                                        ...
                                        <h2 className="mt-1 text-2xl font-bold capitalize tracking-tight text-zinc-900 dark:text-white">
                                            {activeSaturday}º sábado
                                        </h2>
                                    </div>
                                    <div className="flex shrink-0 items-start gap-2">
                                        <div className="text-right">
                                            <p className="text-3xl font-bold tabular-nums leading-none text-zinc-900 dark:text-white">
                                                {confirmedCount}
                                        ...
                                        {canEdit && (
                                            <button
                                                ...
                                                className={`${scheduleIconButtonClass} shrink-0 ${
